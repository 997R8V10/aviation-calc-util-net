...
namespace AviationCalcUtilNet.GeoTools.GribTools
{
    public class GribDataPoint
    {
		...
		[DllImport("aviationcalc")] private static extern double GribDataPointGetGeoPotentialHeightM(IntPtr point);
		[DllImport("aviationcalc")] private static extern void GribDataPointSetGeoPotentialHeightM(IntPtr point, double newGeoPotHtM);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetGeoPotentialHeightFt(IntPtr point);
		[DllImport("aviationcalc")] private static extern int GribDataPointGetLevelHPa(IntPtr point);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetTempK(IntPtr point);
		[DllImport("aviationcalc")] private static extern void GribDataPointSetTempK(IntPtr point, double newTempK);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetTempC(IntPtr point);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetVMpers(IntPtr point);
		[DllImport("aviationcalc")] private static extern void GribDataPointSetVMpers(IntPtr point, double newVMpers);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetUMpers(IntPtr point);
		[DllImport("aviationcalc")] private static extern void GribDataPointSetUMpers(IntPtr point, double newUMpers);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetWindSpeedMpers(IntPtr point);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetWindSpeedKts(IntPtr point);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetWindDirRads(IntPtr point);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetWindDirDegs(IntPtr point);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetRelHumidity(IntPtr point);
		[DllImport("aviationcalc")] private static extern void GribDataPointSetRelHumidity(IntPtr point, double newRelHumidity);
		[DllImport("aviationcalc")] private static extern double GribDataPointGetSfcPressHPa(IntPtr point);
		[DllImport("aviationcalc")] private static extern void GribDataPointSetSfcPressHPa(IntPtr point, double newSfcPressHPa);
